...
DB  0C0H,030H,008H,008H,008H,008H,038H,000H,008H,0F8H,008H,000H,000H,008H,0F8H,008H
...
DB  007H,018H,020H,020H,020H,010H,008H,000H,020H,03FH,021H,001H,001H,021H,03FH,020H
HZ41:
;--  调入了一幅图像：E:\T.bmp  --
;--  宽度x高度=64x16  --
DB  0E7H,0F7H,0F7H,007H,0F7H,0F7H,0E7H,0FFH,0F7H,007H,077H,077H,017H,0F7H,0EFH,0FFH
DB  0F7H,007H,0F7H,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,03FH,03FH,0FFH,0FFH,0FFH
DB  0FFH,01FH,0EFH,0F7H,0F7H,0EFH,01FH,0FFH,0FFH,0C7H,0F7H,0F7H,037H,0C7H,0F7H,0FFH
DB  0FFH,007H,0F7H,077H,077H,0F7H,0F7H,0FFH,0FFH,08FH,077H,0F7H,0F7H,077H,08FH,0FFH
DB  0FFH,0FFH,0DFH,0C0H,0DFH,0FFH,0FFH,0FFH,0DFH,0C0H,0DFH,0DFH,0DCH,0DFH,0E7H,0FFH
DB  0DFH,0C0H,0DFH,0DFH,0DFH,0DFH,0CFH,0FFH,0FFH,0FFH,0FFH,0CFH,0CFH,0FFH,0FFH,0FFH
DB  0FFH,0F0H,0EFH,0DFH,0DFH,0EFH,0F0H,0FFH,0FFH,0FFH,0FFH,0C0H,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0E6H,0DEH,0DFH,0DFH,0EEH,0F1H,0FFH,0FFH,0E3H,0DDH,0DEH,0DEH,0DDH,0E3H,0FFH
HZ42:
;--  调入了一幅图像：E:\-.bmp  --
;--  宽度x高度=64x16  --
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,08FH,0F7H,0F7H,0F7H,077H,08FH,0FFH
DB  0FFH,08FH,0F7H,0F7H,0F7H,077H,08FH,0FFH,0FFH,08FH,0F7H,0F7H,0F7H,077H,08FH,0FFH
DB  0FFH,0CFH,0F7H,077H,077H,0B7H,0CFH,0FFH,0FFH,0EFH,0EFH,007H,0FFH,0FFH,0FFH,0FFH
DB  0FFH,01FH,0EFH,0F7H,0F7H,0EFH,01FH,0FFH,0FFH,01FH,0EFH,077H,077H,0E7H,0FFH,0FFH
DB  0FFH,0FEH,0FEH,0FEH,0FEH,0FEH,0FEH,0FEH,0FFH,0CFH,0D7H,0DBH,0DDH,0DEH,0CFH,0FFH
DB  0FFH,0CFH,0D7H,0DBH,0DDH,0DEH,0CFH,0FFH,0FFH,0CFH,0D7H,0DBH,0DDH,0DEH,0CFH,0FFH
DB  0FFH,0E7H,0DFH,0DFH,0DFH,0EEH,0F1H,0FFH,0FFH,0DFH,0DFH,0C0H,0DFH,0DFH,0FFH,0FFH
DB  0FFH,0FFH,0CEH,0DDH,0DDH,0EEH,0F0H,0FFH,0FFH,0F0H,0EEH,0DFH,0DFH,0EEH,0F1H,0FFH
GPTB1:
...
DB  0C0H,0E0H,070H,000H,000H,080H,0C0H,0E0H,0F0H,000H,000H,000H,080H,0C0H,0E0H,0F0H
DB  000H,000H,000H,000H,000H,080H,0C0H,0C0H,0E0H,0F0H,078H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,080H,080H,080H,080H,080H
DB  0C0H,0C0H,0C0H,0C0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H,0E0H
DB  0E0H,0E0H,0E0H,0C0H,0C0H,0C0H,0C0H,0C0H,080H,080H,080H,080H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,0C0H,0E0H,0F0H,0FFH,0FEH,0FEH,0FCH,0CFH,0CFH
DB  0FFH,0FFH,0FEH,0FEH,0FFH,0FFH,0FFH,0FFH,0FFH,07EH,07EH,07FH,03FH,03FH,03FH,03EH
DB  01EH,01EH,00EH,00EH,007H,003H,003H,001H,001H,000H,000H,000H,000H,080H,0C0H,0E0H
DB  0F0H,0F0H,0F8H,0F8H,0FCH,0FCH,0FEH,0FEH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FBH,0FBH,0FBH,0BBH,0BBH,0B9H,0B9H,0B9H,0B9H,0B9H,039H,039H,039H,039H,039H
DB  071H,071H,071H,071H,0E3H,0E3H,0E3H,0C3H,0C7H,087H,087H,007H,00FH,01FH,01FH,03EH
DB  07CH,0F8H,0E0H,0C0H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  080H,0C0H,0E0H,0F0H,0F8H,0F8H,0F8H,0FBH,0F9H,0FCH,0FCH,0FCH,0FEH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FEH,0FCH,0F8H,0F0H,000H
DB  000H,000H,000H,000H,000H,000H,000H,080H,0C0H,0F0H,0FCH,0FEH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FEH
DB  0FEH,0FEH,0FCH,0FCH,0F0H,0F0H,0E0H,081H,003H,007H,007H,01FH,0FEH,0F8H,000H,000H
...
DB  0F8H,0F8H,0F8H,0F8H,0F8H,0FCH,0FEH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0DFH,0BFH,07FH,0FFH,0FFH,0FFH,0FFH,0FFH,0FBH
DB  0FBH,0F3H,0E7H,00FH,03FH,0FFH,0FFH,07FH,000H,000H,000H,003H,001H,000H,000H,000H
DB  004H,002H,001H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,001H,003H,007H,00FH,01FH,03FH,07FH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
DB  0FFH,0FFH,0FFH,0FFH,07FH,07FH,01FH,001H,087H,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,07FH
DB  0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,07FH,00FH,00FH,000H,003H,0FFH,0FFH,07FH,03FH,00FH
DB  007H,007H,001H,000H,0F8H,0FFH,007H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,001H,003H,007H,00FH,01FH,01FH,03FH
DB  03FH,07FH,07FH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,07FH,03FH,03FH,01FH
DB  01FH,03FH,07FH,07FH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,07FH,007H
DB  003H,003H,00FH,010H,000H,000H,000H,03CH,00FH,007H,007H,007H,003H,000H,000H,01EH
DB  007H,007H,003H,003H,001H,000H,000H,000H,000H,000H,000H,003H,000H,000H,000H,000H
DB  000H,000H,000H,000H,001H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,080H,0C0H,061H,033H,01FH,01FH,01FH,073H,080H,080H,001H,001H,000H
DB  000H,000H,000H,000H,000H,000H,001H,001H,001H,049H,039H,013H,013H,00FH,014H,004H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,008H,00CH,00CH,00CH,00CH,00CH,00CH,014H,00CH,004H
DB  006H,006H,003H,009H,000H,000H,000H,007H,007H,000H,000H,002H,000H,000H,000H,004H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
DB  000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H,000H
